let mapdata=[
  ...
  },
  {
    ...
    "description": "Canal St-Chinatown Er Hu Player: \nThe erhu is a two-stringed bowed musical instrument and is known in the West as the Chinese violin. It can be a solo instrument or played in small emsembles or large orchestras.  Unlike street performers playing western instruments in Time square or Union square, elderly performers in Chinatown bring Chinese traditional sounds to this diverse city.",
...
let indexID =0;
function preload(){
  sound[0] =loadSound(mapdata.features[0].soundaddress,loaded);

  sound[0] =loadSound(mapdata.features[1].soundaddress,loaded);
  sound[0] =loadSound(mapdata.features[2].soundaddress,loaded);
  sound[0] =loadSound(mapdata.features[3].soundaddress,loaded);
  sound[0] =loadSound(mapdata.features[4].soundaddress,loaded);
  img.push(createImg(mapdata.features[0].pictures,'canalst'));
  img.push(createImg(mapdata.features[1].pictures,'canalst'));
  img.push(createImg(mapdata.features[2].pictures,'canalst'));
  img.push(createImg(mapdata.features[3].pictures,'canalst'));
  img.push(createImg(mapdata.features[4].pictures,'canalst'));
